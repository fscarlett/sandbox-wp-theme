...
<head>
	...
	<!-- Hotjar Tracking Code for https://sandboxc6.com/ -->
<script>
    (function(h,o,t,j,a,r){
        h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
        h._hjSettings={hjid:2958762,hjsv:6};
			...
			<div class="header-container-inner">
				...
				<div class="header-nav-wrapper">
					...
					<nav id="site-navigation" class="main-navigation">
						<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Menu', 'sandbox' ); ?></button>
						<?php
						wp_nav_menu(
							array(
